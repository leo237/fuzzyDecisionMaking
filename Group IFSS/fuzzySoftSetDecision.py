...
for i in xrange(judges):
	lineCounter = 0
	fuzzySet = []
	with open('testJudge' + str(i) +'.csv', 'rb') as csvfile:
...
numberOfParameters = len(parameters)/3
...
membershipPriorityTables= []
nonMembershipPriorityTables = []
hesitationPriorityTables = []


for fuzzySet in judgeSet:
	...
	membershipPriorityTables.append(membershipPriorityTable)
	nonMembershipPriorityTables.append(nonMembershipPriorityTable)
	hesitationPriorityTables.append(hesitationPriorityTable)
